...
load data local infile 'goals.csv' into table goals
fields terminated by ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
ignore 1 rows
...
load data local infile 'tournaments.csv' into table tournaments
fields terminated by ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
ignore 1 rows
...
load data local infile 'matches.csv' into table matches
fields terminated by ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
ignore 1 rows
